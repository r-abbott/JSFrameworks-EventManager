...
namespace EM_API.Repositories
{
    public class EventsRepository : InMemoryRepository<Event>
    {
        ...
        {
            new Event(1, "Developing Web Applications with .Net Core","Come out and learn how to make Web Apps using the latest .Net Core framework. We'll go through all the steps and leave you with a working application.",0.00m, DateTime.Parse("01/02/2017 5:00 PM")),
